export const approachingContent = {
  ...
  accountManager: {
    email: {
      subject: 'Account Alert: Approaching nc_workflow_instances Limit',
      greeting: 'Hi Account Manager,',
      body: 'ACME Corp account is at 78% of their nc_workflow_instances quota (7,800 / 10,000). At this pace they\'ll hit the limit in ~14 days.',
      yourMove: 'Coordinate with sales team on upgrade discussion.',
      cta1: 'Go to account',
      cta2: 'View dashboard'
    },
    slack: {
      title: 'Account Alert: Approaching nc_workflow_instances Limit',
      greeting: 'Hi Account Manager,',
      body: 'ACME Corp account is at 78% of their nc_workflow_instances quota (7,800 / 10,000). At this pace they\'ll hit the limit in ~14 days.',
      yourMove: 'Coordinate with sales team on upgrade discussion.',
      cta1: 'Go to account',
