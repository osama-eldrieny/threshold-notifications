...
import {
  MainNav, Avatar, Badge, Alert as TexturaAlert, Button, IconButton, Badge as InlineBadge, Chip,
  PageLayout, List
...
const navigationItems = [
  { type: 'item', label: 'Home', icon: <Home />, hoverIcon: <HomeSolid />, href: '#/exceeding/admin/home', isCurrent: true },
...
export default function ExceedingHome() {
  ...
  return (
    <>
      {/* ── Warning Alert above PageLayout ── */}
      <TexturaAlert 
        variant="warning" 
        treatment="default" 
        type="container-edge" 
        ...
        <PageLayout.Main pageWidth="fullWidth">
          <PageLayout.Body>
            <PageLayout.BodyContent>
              {/* Home Page Content - WITHOUT inline alert (removed on this page) */}
