"use client";
import { bindFirst } from '../../../../../@udecode_utils@52.3.4/node_modules/@udecode/utils/dist/index.js';
import { createEditor as createEditor$1, Range, Node, Element, Path, Point, Text, Span, isEditor, Operation, apply, shouldNormalize, getDirtyPaths, setNormalizing, hasPath, removeMark, normalizeNode, Transforms, insertFragment, insertBreak, getFragment, fragment, deleteFragment, deleteForward, deleteBackward, addMark, wrapNodes, withoutNormalizing, getVoid, unwrapNodes, unsetNodes, unhangRange, string, start, splitNodes, setSelection, setPoint, setNodes, select, removeNodes, rangeRefs, rangeRef, range, positions, pointRefs, pointRef, point, pathRefs, pathRef, path, parent, normalize, Location, node, moveNodes, move, liftNodes, levels, leaf, last, isStart, isNormalizing, isEnd, isEmpty, isEdge, isBlock, insertNodes, hasTexts, hasInlines, hasBlocks, marks, first, end, elementReadOnly, edges, deselect, collapse, before, after, above } from '../../../../../slate@0.124.0/node_modules/slate/dist/index.es.js';
import { DOMEditor } from '../../../../../slate-dom@0.124.0_slate@0.124.0/node_modules/slate-dom/dist/index.es.js';
export { CAN_USE_DOM, HAS_BEFORE_INPUT_SUPPORT, IS_ANDROID, IS_CHROME, IS_FIREFOX, IS_FIREFOX_LEGACY, IS_IOS, IS_UC_MOBILE, IS_WEBKIT, IS_WECHATBROWSER, TRIPLE_CLICK, applyStringDiff, getActiveElement, getDefaultView, getSelection, hasShadowRoot, isAfter, isBefore, isDOMElement, isDOMNode, isDOMSelection, isElementDecorationsEqual, isPlainTextOnlyPaste, isTextDecorationsEqual, isTrackedMutation, mergeStringDiffs, normalizeDOMPoint, normalizePoint, normalizeRange, normalizeStringDiff, targetRange, verifyDiffState, withDOM } from '../../../../../slate-dom@0.124.0_slate@0.124.0/node_modules/slate-dom/dist/index.es.js';
import isPlainObject from '../../../../../../../_virtual/isPlainObject.js';
import castArray from '../../../../../../../_virtual/castArray.js';
import map from '../../../../../../../_virtual/map.js';
...
export { ElementApi, HistoryApi, LocationApi, NodeApi, OperationApi, PathApi, PointApi, RangeApi, SpanApi, TextApi, assignLegacyApi, assignLegacyTransforms, combineMatch, combineMatchOptions, createEditor, getAt, getMatch, getQueryOptions, match, queryNode, syncLegacyMethods, withHistory };
