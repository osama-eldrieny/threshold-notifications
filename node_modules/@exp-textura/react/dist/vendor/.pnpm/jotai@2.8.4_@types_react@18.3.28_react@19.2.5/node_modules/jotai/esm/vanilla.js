...
const createStore$1 = () => {
  ...
  const updateDependencies = (atom2, nextAtomState, nextDependencies, keepPreviousDependencies) => {
    ...
    nextDependencies.forEach((aState, a) => {
      ...
      } else if ((__vite_import_meta_env__ ? "production" : void 0) !== "production") {
  ...
  const readAtomState = (atom2, force) => {
    ...
    const options = {
      ...
      get setSelf() {
        if ((__vite_import_meta_env__ ? "production" : void 0) !== "production" && !isActuallyWritableAtom(atom2)) {
          console.warn("setSelf function cannot be used with read-only atom");
        }
        if (!setSelf && isActuallyWritableAtom(atom2)) {
          setSelf = (...args) => {
            if ((__vite_import_meta_env__ ? "production" : void 0) !== "production" && isSync) {
