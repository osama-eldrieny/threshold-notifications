"use client";
import getDirection from '../../../../../../_virtual/index3.js';
import debounce from '../../../../../../_virtual/debounce.js';
import throttle from '../../../../../../_virtual/throttle.js';
import React, { useContext, forwardRef, useCallback, useState, useRef, useReducer, useMemo, useEffect, createContext, useLayoutEffect, Component, Fragment, memo } from 'react';
import e from '../../../../scroll-into-view-if-needed@3.1.0/node_modules/scroll-into-view-if-needed/dist/index.js';
import { Transforms, Range, Editor, Node, Text as Text$1, Path, Scrubber, Location } from '../../../../slate@0.124.0/node_modules/slate/dist/index.es.js';
import { EDITOR_TO_FORCE_RENDER, IS_READ_ONLY, IS_NODE_MAP_DIRTY, DOMEditor, IS_WEBKIT, getActiveElement, IS_ANDROID, getSelection, IS_FOCUSED, getDefaultView, EDITOR_TO_WINDOW, EDITOR_TO_ELEMENT, NODE_TO_ELEMENT, ELEMENT_TO_NODE, IS_FIREFOX, containsShadowAware, EDITOR_TO_USER_SELECTION, IS_COMPOSING, HAS_BEFORE_INPUT_SUPPORT, PLACEHOLDER_SYMBOL, MARK_PLACEHOLDER_SYMBOL, EDITOR_TO_PENDING_INSERTION_MARKS, isPlainTextOnlyPaste, Hotkeys as hotkeys, IS_CHROME, IS_FIREFOX_LEGACY, IS_IOS, IS_WECHATBROWSER, IS_UC_MOBILE, EDITOR_TO_USER_MARKS, isDOMNode, TRIPLE_CLICK, isDOMElement, CAN_USE_DOM, EDITOR_TO_SCHEDULE_FLUSH, EDITOR_TO_ON_CHANGE, NODE_TO_INDEX, NODE_TO_PARENT, isTrackedMutation, EDITOR_TO_PENDING_DIFFS, applyStringDiff, isDOMSelection, EDITOR_TO_PENDING_SELECTION, EDITOR_TO_PENDING_ACTION, targetRange, verifyDiffState, splitDecorationsByChild, isElementDecorationsEqual, EDITOR_TO_PLACEHOLDER_ELEMENT, normalizeStringDiff, mergeStringDiffs, normalizeRange, normalizePoint, EDITOR_TO_KEY_TO_ELEMENT, isTextDecorationsEqual, withDOM, Key } from '../../../../slate-dom@0.124.0_slate@0.124.0/node_modules/slate-dom/dist/index.es.js';
import { ResizeObserver } from '../../../../@juggle_resize-observer@3.4.0/node_modules/@juggle/resize-observer/lib/ResizeObserver.js';
import '../../../../@juggle_resize-observer@3.4.0/node_modules/@juggle/resize-observer/lib/algorithms/calculateBoxSize.js';
...
export { DefaultElement, DefaultLeaf, DefaultPlaceholder, DefaultText, Editable, NODE_TO_INDEX, NODE_TO_PARENT, ReactEditor, Slate, defaultScrollSelectionIntoView, useComposing, useFocused, useReadOnly, useSlate, useSlateStatic, withReact };
