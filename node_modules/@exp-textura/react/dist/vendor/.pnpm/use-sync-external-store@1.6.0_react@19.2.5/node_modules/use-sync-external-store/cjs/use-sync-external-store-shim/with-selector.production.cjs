...
const withSelector_production = require('../../../../../../../_virtual/with-selector.production.cjs');
...
function requireWithSelector_production () {
	...
	withSelector_production.__exports.useSyncExternalStoreWithSelector = function (
	  subscribe,
	  getSnapshot,
	  getServerSnapshot,
	  selector,
...
//# sourceMappingURL=with-selector.production.cjs.map
