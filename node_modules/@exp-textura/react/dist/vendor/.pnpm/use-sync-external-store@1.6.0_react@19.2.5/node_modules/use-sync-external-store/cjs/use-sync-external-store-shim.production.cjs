...
const useSyncExternalStoreShim_production = require('../../../../../../_virtual/use-sync-external-store-shim.production.cjs');
...
function requireUseSyncExternalStoreShim_production () {
	...
	useSyncExternalStoreShim_production.__exports.useSyncExternalStore =
