...
const createSlotComponent = (element) => React.forwardRef((t0, ref) => {
	...
	const Comp = (t1 === void 0 ? false : t1) ? reactSlot.Slot : as || element;
	let t2;
...
const createPrimitiveComponent = (element) => {
	...
	return ({ propsHook, stateHook } = {}) => React.forwardRef((t0, ref) => {
		...
		const state = index$1.isDefined(stateProp) ? stateProp : stateHook ? stateHook(options) : void 0;
		...
		const className = index$1.isDefined(hookProps?.className) || index$1.isDefined(classNameProp) ? clsx$1.clsx(hookProps?.className, classNameProp) : void 0;
...
exports.useMemoizedSelector = useMemoizedSelector;
exports.useOnClickOutside = useOnClickOutside;
exports.useStableFn = useStableFn;
