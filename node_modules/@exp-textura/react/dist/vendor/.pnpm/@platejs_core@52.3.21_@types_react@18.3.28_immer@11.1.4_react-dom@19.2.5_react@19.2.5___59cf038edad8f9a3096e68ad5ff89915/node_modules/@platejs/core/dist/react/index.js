"use client";
import { f as isEditOnly, tt as ChunkingPlugin, Gt as getEditorPlugin$1, zt as getPluginByType, n as withSlate, dt as getPluginNodeProps, ut as getSlateClass, Kt as createSlatePlugin, s as SlateExtensionPlugin, Z as DOMPlugin, Pt as BaseParagraphPlugin } from '../withSlate-BfRR5wTZ.js';
import { t as Hotkeys } from '../hotkeys-DI1HPO2Q.js';
import { k as pipeDecorate, A as pipeInjectNodeProps } from '../static-DIYyt_jS.js';
import { createEditor, PathApi } from '../../../../../../@platejs_slate@52.3.21/node_modules/@platejs/slate/dist/index.js';
import { isDefined } from '../../../../../../@udecode_utils@52.3.4/node_modules/@udecode/utils/dist/index.js';
import { Editable, useFocused, Slate, useReadOnly, withReact, useComposing } from '../../../../../../slate-react@0.124.0_react-dom@19.2.5_react@19.2.5__react@19.2.5_slate-dom@0.124.0_slate@0.124.0__slate@0.124.0/node_modules/slate-react/dist/index.es.js';
export { DefaultPlaceholder, useSlateStatic } from '../../../../../../slate-react@0.124.0_react-dom@19.2.5_react@19.2.5__react@19.2.5_slate-dom@0.124.0_slate@0.124.0__slate@0.124.0/node_modules/slate-react/dist/index.es.js';
import { d as distExports } from '../../../../../../../../_virtual/index.js';
import React, { useRef, useId, useEffect } from 'react';
import { useHotkeys, Key } from '../../../../../../@udecode_react-hotkeys@52.0.11_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@udecode/react-hotkeys/dist/index.js';
import { useStoreAtomValue, useAtomStoreValue, useAtomStoreSet, createAtomStore } from '../../../../../../jotai-x@2.3.3_@types_react@18.3.28_jotai@2.8.4_@types_react@18.3.28_react@19.2.5__react@19.2.5/node_modules/jotai-x/dist/index.js';
import { createZustandStore, useStoreSelect, useStoreValue } from '../../../../../../zustand-x@6.2.1_react-dom@19.2.5_react@19.2.5__react@19.2.5_scheduler@0.27.0_zustand@5._14c22be228d6642d328e08205e63ae2d/node_modules/zustand-x/dist/index.js';
import clsx$1, { clsx } from 'clsx';
import omit from '../../../../../../../../_virtual/omit.js';
import { useDeepCompareMemo } from '../../../../../../use-deep-compare@1.3.0_react@19.2.5/node_modules/use-deep-compare/dist-web/index.js';
import { useComposedRef, useStableFn, useMemoizedSelector } from '../../../../../../@udecode_react-utils@52.3.4_@types_react@18.3.28_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@udecode/react-utils/dist/index.js';
import { selectAtom } from '../../../../../../jotai@2.8.4_@types_react@18.3.28_react@19.2.5/node_modules/jotai/esm/vanilla/utils.js';
import { focusAtom } from '../../../../../../jotai-optics@0.4.0_jotai@2.8.4_@types_react@18.3.28_react@19.2.5__optics-ts@2.4.1/node_modules/jotai-optics/dist/focusAtom.js';
...
function useEditorPluginOption(editor, plugin, key, ...args) {
	...
	if (key === "state") return useStoreSelect(store, (state) => state, args[0]);
...
export { BLUR_EDITOR_EVENT, BelowRootNodes, ContentVisibilityChunk, DOM_HANDLERS, Editable, EditorHotkeysEffect, EditorMethodsEffect, EditorRefEffect, EditorRefPluginEffect, ElementProvider, EventEditorPlugin, EventEditorStore, FOCUS_EDITOR_EVENT, ParagraphPlugin, Plate, PlateContent, PlateControllerEffect, PlateElement, PlateLeaf, PlateSlate, PlateStoreProvider, PlateText, ReactPlugin, SCOPE_ELEMENT, Slate, SlateReactExtensionPlugin, atom, convertDomEventToSyntheticEvent, createAtomStore, createPlateEditor, createPlateFallbackEditor, createPlatePlugin, createPlateStore, createZustandStore, getEditorPlugin, getPlateCorePlugins, getPlugin, getRenderNodeProps, isEventHandled, pipeHandler, pipeOnChange, pipeRenderElement, pipeRenderLeaf, pipeRenderText, plateControllerStore, plateStore, pluginRenderElement, pluginRenderLeaf, pluginRenderText, toPlatePlugin, toTPlatePlugin, useComposing, useEditableProps, useEditorId, useEditorMounted, useEditorPlugin, useEditorPluginOption, useEditorReadOnly, useEditorRef, useEditorSelection, useEditorSelector, useEditorVersion, useElement, useElementStore, useEventEditorValue, useFocused, useIncrementVersion, useNodeAttributes, useNodePath, usePath, usePlateControllerExists, usePlateControllerLocalStore, usePlateControllerStore, usePlateEditor, usePlateLocalStore, usePlateStore, usePluginOption, useReadOnly, useRedecorate, useSlateProps, useStoreAtomValue, useStoreSelect, useStoreValue, withPlate, withPlateReact, withReact };
